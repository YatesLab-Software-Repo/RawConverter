...
namespace RawConverter.GUI
{
    public partial class RawConverterGUI : Form
    {
        ...
        private void gbOutput_Enter(object sender, EventArgs e)
        {

        }

        private void labelOutFormat_Click(object sender, EventArgs e)
        {

        }

        private void cbMs1_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void cbMgf_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void cbMzXML_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void cbMs2_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void cbMs3_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void cbMzML_CheckedChanged(object sender, EventArgs e)
        {
